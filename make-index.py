...
make-index.py </path/to/directory> [--header <header text>]

Adapted from https://stackoverflow.com/a/39402604/14420 by @matthew-brett
"""
...
#    header = os.path.basename(dir)
    ...
    f.close()
    # We don't want to process subfolders
